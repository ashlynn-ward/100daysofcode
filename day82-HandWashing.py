...
#Ashlynn Ward, September 6, 2025
#This program was copied from my Google Colab Notebook. It was used to analyze the work of Dr. Semmelweiss related to
#the effects of hand washing on death rates during childbirth. 
...
before_pct = before.deaths.sum() / before.births.sum() * 100
after_pct = after.deaths.sum() / after.births.sum() * 100
...
avg_prob_before = before.pct_deaths.mean() * 100
