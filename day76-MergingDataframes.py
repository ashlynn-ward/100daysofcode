#Merging Dataframes
#Ashlynn Ward, August 30, 2025
#This program was copied from my Google Colab Notebook. It shows the practice I completed related to merging dataframes.
...
plt.plot(themes_by_year.index[:-3], themes_by_year.num_themes[:-3])
