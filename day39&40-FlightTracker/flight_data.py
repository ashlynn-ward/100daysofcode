...
class FlightData:
    #Class requires flight details to be provided
    def __init__(self, price, origin_airport, destination_airport, out_date, return_date, stops):
        ...
        #If there are no direct flights, stops>0
        self.stops=stops
    
    #Method find cheapest flight accesses flight data from Amadeus API and finds determines the cheapest price
