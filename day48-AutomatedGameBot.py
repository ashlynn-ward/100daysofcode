#Automated Game Bot
#Ashlynn Ward, June 27, 2025
#This program uses selenium to automate game play for the Cookie Clicker game.
...
#Wait for program to load just in case
sleep(3)
...
#Continually click the button
while True:
    cookie.click()

    #Buy the most expensive item available
    try:
...
#Find cookies/second after 5 minutes
cookies_per_second = driver.find_element(By.ID, value="cookiesPerSecond")
print(f"Cookies/sec: {cookies_per_second.text}")